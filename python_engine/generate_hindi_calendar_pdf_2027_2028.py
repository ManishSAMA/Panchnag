...
def generate_hindi_pdf_calendar_2027_2028(out_pdf_path: str, lat: float = 26.9124, lon: float = 75.7873, tz_offset: float = 5.5, ayanamsa: str = "Lahiri", profile: str = "all"):
    # Load festivals for 2027 and 2028
    ...
    date_to_fests = {}
    for res in [fest_2027, fest_2028]:
    ...
    html_parts = [
        ...
        "<head>",
        "<meta charset='utf-8'>",
        "<title>जैन एवं वैदिक पंचांग (मार्च 2027 - मार्च 2028)</title>",
        "<style>",
    ...
    html_parts.append("<h1>जैन एवं वैदिक सम्पूर्ण पंचांग (मार्च 2027 – मार्च 2028)</h1>")
    ...
    for idx, (yr, mo) in enumerate(months_list):
        ...
        for d in range(1, num_days + 1):
            ...
            cs1_anchor = cs1_2027 if yr == 2027 else cs1_2028
            diwali_anchor = diwali_2027 if yr == 2027 else diwali_2028
...
if __name__ == "__main__":
    ...
    generate_hindi_pdf_calendar_2027_2028("output/Jain_Vedic_Panchang_March_2027_March_2028_Hindi.pdf")
