...
def generate_hindi_pdf_calendar_2028_2029(out_pdf_path: str, lat: float = 26.9124, lon: float = 75.7873, tz_offset: float = 5.5, ayanamsa: str = "Lahiri", profile: str = "all"):
    # Load festivals for 2028 and 2029
    fest_2028 = generate_jain_festivals(2028, lat, lon, ayanamsa, profile)
    fest_2029 = generate_jain_festivals(2029, lat, lon, ayanamsa, profile)

    date_to_fests = {}
    for res in [fest_2028, fest_2029]:
    ...
    cs1_2028 = find_chaitra_shukla_1(2028, lat, lon, tz_offset, ayanamsa)
    diwali_2028 = find_diwali(2028, lat, lon, tz_offset, ayanamsa)
    cs1_2029 = find_chaitra_shukla_1(2029, lat, lon, tz_offset, ayanamsa)
    diwali_2029 = find_diwali(2029, lat, lon, tz_offset, ayanamsa)
    ...
    html_parts = [
        ...
        "<head>",
        "<meta charset='utf-8'>",
        "<title>जैन एवं वैदिक पंचांग (मार्च 2028 - मार्च 2029)</title>",
        "<style>",
    ...
    html_parts.append("<h1>जैन एवं वैदिक सम्पूर्ण पंचांग (मार्च 2028 – मार्च 2029)</h1>")
    html_parts.append("<p>सूर्योदय, सूर्यास्त, चंद्रोदय, चंद्रास्त, तिथि, पक्ष, वार एवं समस्त जैन/वैदिक पर्व एवं त्योहार</p>")
    html_parts.append("</div>")

    months_list = [
        (2028, 3), (2028, 4), (2028, 5), (2028, 6), (2028, 7), (2028, 8),
        (2028, 9), (2028, 10), (2028, 11), (2028, 12),
    ...
    for idx, (yr, mo) in enumerate(months_list):
        ...
        for d in range(1, num_days + 1):
            ...
            # Tithi calculation from Tithi_Index (1 to 30)
            ...
            cs1_anchor = cs1_2028 if yr == 2028 else cs1_2029
            diwali_anchor = diwali_2028 if yr == 2028 else diwali_2029
...
if __name__ == "__main__":
    ...
    generate_hindi_pdf_calendar_2028_2029("output/Jain_Vedic_Panchang_March_2028_March_2029_Hindi.pdf")
