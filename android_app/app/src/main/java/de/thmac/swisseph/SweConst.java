...
public class SweConst implements java.io.Serializable {
	 ...
	 * 
	 * @see de.thmac.swisseph.SwissEph#swe_rise_trans(double, int,
	 *      java.lang.StringBuffer, int, int, double[], double, double,
	 *      de.thmac.swisseph.DblObj, java.lang.StringBuffer)
	 */
	 ...
	 * 
	 * @see de.thmac.swisseph.SwissEph#swe_azalt(double, int, double[], double,
	 ...
	 * 
	 * @see de.thmac.swisseph.SwissEph#swe_azalt_rev(double, int, double[],
	 *      double[], double[])
	 */
	 ...
	 * 
	 * @see de.thmac.swisseph.SwissEph#swe_refrac(double, double, double, int)
	 * @see #SE_APP_TO_TRUE
	 */
