...
public class TCHouses extends TransitCalculator implements java.io.Serializable {
	 ...
	 * @see de.thmac.swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int,
	 *      int, double)
	 * @see de.thmac.swisseph.TCPlanet#TCPlanet(SwissEph, int, int, double)
	 * @see de.thmac.swisseph.SweConst#SEFLG_TRANSIT_LONGITUDE
	 * @see de.thmac.swisseph.SweConst#SEFLG_SIDEREAL
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE1
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE2
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE3
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE4
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE5
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE6
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE7
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE8
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE9
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE10
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE11
	 * @see de.thmac.swisseph.SweConst#SE_HOUSE12
	 * @see de.thmac.swisseph.SweConst#SE_ASC
	 * @see de.thmac.swisseph.SweConst#SE_MC
	 * @see de.thmac.swisseph.SweConst#SE_ARMC
	 * @see de.thmac.swisseph.SweConst#SE_VERTEX
	 * @see de.thmac.swisseph.SweConst#SE_EQUASC
	 * @see de.thmac.swisseph.SweConst#SE_COASC1
	 * @see de.thmac.swisseph.SweConst#SE_COASC2
	 * @see de.thmac.swisseph.SweConst#SE_POLASC
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_PLACIDUS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_KOCH
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_PORPHYRIUS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_REGIOMONTANUS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_CAMPANUS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_EQUAL
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_VEHLOW
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_MERIDIAN
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_HORIZONTAL
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_POLICH_PAGE
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_ALCABITIUS // * @see
	 *      swisseph.SweConst#SE_HSYS_GAUQUELIN_SECTORS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_MORINUS
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_KRUSINSKI
	 * @see de.thmac.swisseph.SweConst#SE_HSYS_WHOLE_SIGN
	 */
