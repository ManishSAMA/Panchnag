...
class Swecl implements java.io.Serializable {
	...
	*         declare as attr[20] at least !<BR>
	 ...
	 * @see de.thmac.swisseph.SweConst#OK
	 * @see de.thmac.swisseph.SweConst#ERR
	 ...
	 * @see de.thmac.swisseph.SweConst#SEFLG_SWIEPH
	 * @see de.thmac.swisseph.SweConst#SEFLG_MOSEPH
	 * @see de.thmac.swisseph.SweConst#SE_CALC_RISE
	 * @see de.thmac.swisseph.SweConst#SE_CALC_SET
	 * @see de.thmac.swisseph.SweConst#SE_CALC_MTRANSIT
	 * @see de.thmac.swisseph.SweConst#SE_CALC_ITRANSIT
	 * @see de.thmac.swisseph.SweConst#SE_BIT_DISC_CENTER
	 * @see de.thmac.swisseph.SweConst#SE_BIT_DISC_BOTTOM
	 * @see de.thmac.swisseph.SweConst#SE_BIT_NO_REFRACTION
	 * @see de.thmac.swisseph.SweConst#SE_BIT_FIXED_DISC_SIZE
	 * @see de.thmac.swisseph.DblObj
	 */
	 ...
	 * @see de.thmac.swisseph.SweConst#OK
	 * @see de.thmac.swisseph.SweConst#ERR
	 * @see de.thmac.swisseph.SweConst#SE_NODBIT_MEAN
	 * @see de.thmac.swisseph.SweConst#SE_NODBIT_OSCU
	 * @see de.thmac.swisseph.SweConst#SE_NODBIT_OSCU_BAR
	 * @see de.thmac.swisseph.SweConst#SE_NODBIT_FOPOINT
	 */
